...
const Groups: React.FC = () => {
  ...
  const columns: ColumnsType<TelegramGroup> = [
    ...
    { title: "Sessiya", dataIndex: "sessionName", key: "sessionName", width: 160, render: (v: string | null, r: TelegramGroup) => <Select value={v || undefined} placeholder="Tayinlash..." size="small" style={{ width: 140 }} allowClear onChange={() => {}} options={sessions.map((s) => ({ value: s, label: s }))} /> },
